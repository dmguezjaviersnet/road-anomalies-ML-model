        ...
        if len(X) > 10:
            ...
            for n_features_to_select in [3, 6, 9]:
                ...
                for selector_name, features_selected_set in features_selected_sets:
                    ...
                    #confusion_m
                    for model_name, result, prec, recall,  acc, f1, confusion_m in ms_results:
                        print(f"----- Results with {model_name} model and {outl_method_name} outlier mehotd-----")
                        print(f"{result}\n\n")
                        matrix_id = generate_unique_id_matrix(model_name)
